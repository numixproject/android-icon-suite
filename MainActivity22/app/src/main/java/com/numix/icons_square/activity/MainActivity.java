...
import com.numix.icons_square.fragment.MainFragment;
import com.numix.icons_square.util.GlassActionBarHelper;
import com.numix.icons_square.util.Utils;
...
public class MainActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(Html.fromHtml("<font color='#ffffff'>Numix Square</font>"));
