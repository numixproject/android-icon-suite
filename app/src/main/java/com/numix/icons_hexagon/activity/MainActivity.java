...
import com.numix.icons_hexagon.fragment.MainFragment;
import com.numix.icons_hexagon.util.GlassActionBarHelper;
import com.numix.icons_hexagon.util.Utils;
...
public class MainActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(Html.fromHtml("<font color='#ffffff'>Numix Hexagon</font>"));
